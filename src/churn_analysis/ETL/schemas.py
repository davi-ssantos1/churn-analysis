...
class CustomRecord(BaseModel):
    ...
    def transform_yes_no_to_true_false(cls, value: str | bool) -> bool:
        ...
        try:
            ...
            if strip_value == "yes":
                ...
                raise ValueError(f"Not recognized value: {value}")
        except AttributeError as e:
            raise Exception(
                f"Value must be a str or bool.\nValue: {value}.\nError {e}"
            ) from e
    ...
    def transform_yes_no_notinternetservice_to_true_false(
        ...
        try:
            ...
            if strip_value == "yes":
                ...
                raise ValueError(f"Not recognized value.\nValue: {value}")
        except AttributeError as e:
            raise Exception(f"Value must be an string or bool.\nValue: {value}.") from e
    ...
    def transform_empty_values_to_none(cls, value: str | float | None) -> float | None:
        ...
        raise TypeError(f"{value} must to be a str, float or None.")
